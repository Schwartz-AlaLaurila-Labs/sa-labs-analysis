classdef DataCuratorView < appbox.View
    ...
    methods
        ...
        function createUi(obj)
            ...
            obj.shortCutMenu.undoDeleteEpochsTag = uimenu(obj.shortCutMenu.root, ...
                 'Accelerator', 'R', ...
                'Label', 'Undo Remove Devices', ...
                'Callback', @(h,d)notify(obj, 'UndoRemoveDevicesFromEpoch'));
            layout = uix.VBox(...
           ...
           obj.loadH5FileButton = uicontrol( ...
            ...
            set(signalPreProcessingLayout, 'Heights', [30 -1 30 30 -1 30 -1 -3 30]);
        ...
        function enableAvailableCellMenu(obj, tf)
